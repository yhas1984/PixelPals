...
| Time | Visual | ES message | EN message | Sound identity |
| --- | --- | --- | --- | --- |
...
| 24.5–26.5 s | Full 15-pet party illustration | Una gran familia, 15 vidas únicas | One big family, 15 unique lives | Three-note celebration flourish |
| 26.5–28.0 s | Localized closing card over feature artwork | Adopta a tu compañero | Meet your new companion | Resolved chord and two-note sign-off |

The cut contains 23 seconds of actual app experience, or about 82% of its
28-second running time. Opening, party and closing artwork are kept brief so
that the home experience appears after 1.5 seconds.
