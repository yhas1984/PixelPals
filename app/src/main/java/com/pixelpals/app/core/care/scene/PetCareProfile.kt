...
enum class CareToy { BALL, BUBBLE, RAINBOW, SPRING, FEATHER, HALO, LEAF, BALLOONS, DANCING_LEAF, CRYSTAL, SNOWBALL, PUCK, PINWHEEL, HOOP, SILK, MAGIC_ORB }
...
enum class CarePlayStyle { FETCH, FLOAT, PAW, BOUNCE, GLIDE, PADDLE, BALLOON_POP, PEEK, TWIRL, SNOW_THROW, SLIDE, FOLLOW, SLITHER, WEB, MAGIC_CHASE, CLOUD_DRIFT }
enum class CareTouchStyle { NUZZLE, FADE, SQUISH, WINGS, MISCHIEF, SHIMMER, FLURRY, SHELL, COIL, SILK, GLOW, CLOUD_PUFF }
enum class CareWashStyle { SPONGE, MIST, BRUSH, SPLASH, SPARKLES, SNOW, SHOWER }
...
data class PetCareProfile(
    ...
    companion object {
        fun forPet(pet: PetType): PetCareProfile = when (pet) {
            ...
            PetType.YUKI -> PetCareProfile(CareFood.SNOWFLAKE, CareToy.SNOWBALL, CareBed.SNOW, CareFeedingStyle.ABSORB, CarePlayStyle.SNOW_THROW, CareTouchStyle.FLURRY, CareWashStyle.SHOWER, .8f)
