...
class PetView(
    ...
    override val spriteFrameContentFractions: FloatArray = when (petType) {
        ...
        PetType.MENTA -> floatArrayOf(0.8516f, 0.8555f, 0.8438f, 0.8555f, 0.8438f, 0.8477f, 0.8320f, 0.8516f, 0.9258f, 0.9219f, 0.9180f, 0.9258f, 0.2930f, 0.4961f, 0.3008f, 0.8672f)
